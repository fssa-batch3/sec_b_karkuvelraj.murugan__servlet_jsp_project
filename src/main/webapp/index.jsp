...
<jsp:include page="header.jsp"></jsp:include>
        ...
        <section class="offers">
            <div>
                <a href="">
                    <i class="fas fa-shipping-fast" style="font-size:48px;color:white"></i>
                </a>
            ...
            <div>
                <a href="">
                    <i class="fa fa-exchange" style="font-size:48px;color:white"></i>
                </a>
                <h2>Exchange &</h2>
                <h2>Returns</h2>
            </div>
            <div>
                <a href="">
                    <i class="fas fa-vote-yea" style="font-size:48px;color:white"></i>
                </a>
                <h2>Authentic</h2>
                <h2>Products</h2>
            </div>
